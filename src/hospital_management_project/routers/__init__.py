...
def create_appointment(appointment: AppointmentCreate, db: Session = Depends(get_db)):  # noqa: B008
...
def get_appointment(appointment_id: int, db: Session = Depends(get_db)):  # noqa: B008
